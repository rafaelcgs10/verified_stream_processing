  ...
  proof -
    ...
    moreover have "\<exists>op2'. wstep (Out pa (BHD pa A3)) (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3))))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum (BTL pa A3') (BTL pa A3))))) op2'"
      ...
      subgoal for m n C
        ...
        subgoal
          using tested_Cons_cases[where n=n and xs="C pa" and ys="((B1'' >> B2'') >> B3'') pa" and z="BHD pa A3'" and zs="tl ((A2' >> A3') pa)"]
          apply -
          apply (drule meta_mp)
    ...
    moreover have "\<exists>op2'. wstep (Out pa None) (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3))))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum (BTL pa A3') (BTL pa A3))))) op2'"
      ...
      subgoal for m n C
        apply (intro exI conjI)
         apply (rule wstep_trans(1))
          apply (rule progress_buffers1)
           apply assumption
          apply blast
         apply (rule step_map_op[of \<open>Out pa None\<close>])
          apply (rule step_map_op[of \<open>Out (Inr pa) None\<close>])
           apply (rule step_comp_op_R_Out)
             apply (rule step_aeq_op_Write)
                 apply simp_all
           apply fastforce
        ...
        subgoal
          ...
          apply simp
          apply (subst tested_all)
          by (smt (verit, ccfv_threshold) BULK_BENQ_empty list.collapse list.map_disc_iff min.commute tested_Cons_cases tested_all tested_comm zip_eq_Nil_iff)
          done
        subgoal
          apply (rule wbc_base)
          apply (intro exI conjI)
...
next
  ...
  then show ?case
  proof -
    have "\<exists>op2'. wstep (Inp (Inl (Inl pb)) xb) (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op (BENQ pb xb B1'')) (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "pb \<notin> defaults"
      for pb :: 'a
        and xb :: "'b option"
      ...
      subgoal for m n C
        apply (intro exI conjI)
         apply (rule step_wstep)
         apply (rule step_map_op[of \<open>Inp (Inl (Inl (Inl pb))) xb\<close>])
           apply fastforce
          apply simp+
        apply (rule wbc_base)
        apply (intro exI conjI)
        ...
        subgoal for p
          ...
          subgoal
            ...
            apply (intro conjI)
                    apply (simp_all add: tested_def)
             apply (smt (verit, ccfv_SIG) BAPPEND_BENQ BENQ_access append_eq_append_conv_if append_take_drop_id length_append_singleton length_take min_def not_less_eq_eq)
            by (metis (no_types, opaque_lifting) BAPPEND_BENQ BENQ_access le_Suc_eq length_Suc_conv_rev)
          subgoal
            using that(1) apply -
            apply (drule spec[of _ p])
            apply (elim conjE exE)
            subgoal for m' n' C'
              ...
              apply (rule exI[of _ n'])
              apply (intro conjI)
               apply (metis BAPPEND_BENQ BENQ_diff_access)
              apply (rule exI[of _ C'])
                    apply (simp_all add: BENQ_def BULK_BENQ_bulk_benq)
              done
            done
    ...
    moreover have "\<exists>op2'. wstep (Inp (Inl (Inr pb)) y) (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum (BENQ pb y B1') B1))) (aeq_op (case_sum B3'' B3)))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "pb \<notin> defaults"
      for pb :: 'a
        and y :: "'b option"
      ...
      subgoal for m n C
        apply (intro exI conjI)
         apply (rule step_wstep)
         apply (rule step_map_op[of \<open>Inp (Inl (Inl (Inr pb))) y\<close>])
           apply fastforce
          apply simp+
        apply (rule wbc_base)
        apply (intro exI conjI)
    ...
    moreover have "\<exists>op2'. wstep (Inp (Inr pb) y) (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' (BENQ pb y B1)))) (aeq_op (case_sum B3'' B3)))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "pb \<notin> defaults"
      for pb :: 'a
        and y :: "'b option"
      ...
      subgoal for m n C
        apply (intro exI conjI)
         apply (rule step_wstep)
         apply (rule step_map_op[of \<open>Inp (Inl (Inr pb)) y\<close>])
           apply fastforce
          apply simp+
        apply (rule wbc_base)
        apply (intro exI conjI)
    ...
    moreover have "\<exists>op2'. wstep (Out pa (BHD pa B3)) (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum (BTL pa B3'') (BTL pa B3))))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "B3'' pa \<noteq> []"
        and "B3 pa \<noteq> []"
        and "pa \<notin> defaults"
        and "BHD pa B3'' = BHD pa B3"
      for pa :: 'a
      using that
      apply -
      apply (drule spec[of _ pa])
      ...
      subgoal for m n C
        apply (intro exI conjI)
         apply (rule wstep_trans(1))
          apply (rule progress_buffers2)
           apply assumption
          apply blast
         apply (rule step_map_op[of \<open>Out (Inr pa) (BHD pa B3)\<close>])
          apply (rule step_comp_op_R_Out)
            apply (rule step_aeq_op_Write)
                apply simp_all
           apply (metis (no_types, lifting) BULK_BENQ_empty drop_Nil drop_eq_Nil le_antisym length_0_conv length_drop length_tested_0 min_def nat_le_linear tested_empty)
           apply fastforce
         apply auto[1]
           apply (smt (verit, del_insts) BHD_BULK_BENQ_cases BHD_def BULK_BENQ_empty fun_upd_same length_0_conv length_drop list.collapse min.cobounded1 min_def tested_Cons_cases tested_comm tested_empty tested_min_drop)
        subgoal
          using tested_Cons_cases[where n=m and ys="C pa" and xs="((A1 >> A2) >> A3) pa" and z="BHD pa B3" and zs="tl ((B2 >> B3) pa)"]
          apply -
          apply (drule meta_mp)
           apply (metis BHD_BULK_BENQ_cases BHD_def BULK_BENQ_empty list.collapse)
          apply (elim disjE conjE)
          subgoal
            ...
            apply (subst tested_min_drop[symmetric])
               apply (rule refl)+
             apply (rule tested_comm)
            apply (subst tested_Suc[where n="min (length (((B1'' >> B2'') >> B3'') pa)) (length (C pa)) - 1"])
                apply simp_all
            apply (simp split: if_splits)
            apply (metis BHD_BULK_BENQ_cases BHD_def BULK_BENQ_empty fun_upd_same list.sel(1))
            done
        ...
        subgoal
          unfolding BHD_def
          apply (simp add: fun_upd_same flip: length_drop)
          by (smt (verit, ccfv_threshold) BHD_BULK_BENQ_cases BHD_def BULK_BENQ_empty length_0_conv list.collapse min_def nat_le_linear tested_Cons_cases tested_comm tested_empty tested_min_drop)
        subgoal
          apply (rule wbc_base)
          apply (intro exI conjI)
              apply (rule refl)+
          ...
          subgoal for p
            ...
            subgoal
              ...
              subgoal for m'
                apply (rule exI[of _ m'])
                apply (rule exI[of _ \<open>min (length (btl ((B1'' >> B2'' >> B3'') pa))) (length (btl (C pa)))\<close>])
                apply (intro conjI)
                 apply (smt (verit, del_insts) BTL_access BULK_BENQ_assoc BULK_BENQ_bulk_benq Suc_le_D add.commute add_diff_cancel_left' drop_Suc drop_eq_Nil fun_upd_same le_add_diff_inverse length_tl min.cobounded1 min_add_distrib_left min_def plus_1_eq_Suc tl_append2)
                apply (rule exI[of _ \<open>BTL pa C\<close>])
                apply (intro conjI)
                        apply (simp_all add: BTL_def drop_Suc)
                   apply (smt (verit, del_insts) BULK_BENQ_empty One_nat_def Suc_pred add.commute add_leD1 drop_Suc le_add_diff_inverse2 length_greater_0_conv min_add_distrib_left plus_1_eq_Suc)
                  apply (smt (verit, ccfv_threshold) BULK_BENQ_bulk_benq One_nat_def fun_upd_same length_drop length_tl tested_all_tl tested_comm tested_min_drop tl_append2)
                 apply (smt (verit, ccfv_threshold) BULK_BENQ_bulk_benq fun_upd_same leD length_0_conv less_Suc_eq_0_disj list.sel(3) tested_diff_Suc tested_eq_Suc tl_append2)
                by (simp add: BULK_BENQ_bulk_benq)
              done
            subgoal
    ...
    moreover have "\<exists>op2'. wstep (Out pa None) (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum (BTL pa B3'') (BTL pa B3))))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "B3'' pa \<noteq> []"
        and "B3 pa \<noteq> []"
        and "pa \<notin> defaults"
        and "BHD pa B3'' \<noteq> BHD pa B3"
      for pa :: 'a
      using that
      apply -
      apply (drule spec[of _ pa])
    ...
    moreover have "\<exists>op2'. (step Tau)\<^sup>*\<^sup>* (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' (BENQ pb (BHD pb B1) B2)) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum (BTL pb B1') (BTL pb B1)))) (aeq_op (case_sum B3'' B3)))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "B1' pb \<noteq> []"
        and "B1 pb \<noteq> []"
        and "pb \<notin> defaults"
        and "BHD pb B1' = BHD pb B1"
      for pb :: 'a
      using that
      apply -
      apply (drule spec[of _ pb])
        ...
        subgoal for p
          ...
          subgoal
            ...
            apply (rule exI[of _ C])
              ...
              apply simp_all
              apply (metis BTL_access drop_Suc tl_drop)
             apply (metis BTL_access drop_Suc drop_tl)
            by (metis BAPPEND_BENQ BENQ_access BHD_def hd_drop_conv_nth le_neq_implies_less tested_eq_Suc_gen)
          subgoal
            using that(1) apply -
            apply (drule spec[of _ p])
    ...
    moreover have "\<exists>op2'. (step Tau)\<^sup>*\<^sup>* (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' (BENQ pb None B2)) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum (BTL pb B1') (BTL pb B1)))) (aeq_op (case_sum B3'' B3)))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "B1' pb \<noteq> []"
        and "B1 pb \<noteq> []"
        and "pb \<notin> defaults"
        and "BHD pb B1' \<noteq> BHD pb B1"
      for pb :: 'a
      using that
      apply -
      apply (drule spec[of _ pb])
    ...
    moreover have "\<exists>op2'. (step Tau)\<^sup>*\<^sup>* (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum (BENQ pb (BHD pb B1'') B2'') B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op (BTL pb B1'')) (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "pb \<notin> defaults"
        and "B1'' pb \<noteq> []"
      for pb :: 'a
    ...
    moreover have "\<exists>op2'. (step Tau)\<^sup>*\<^sup>* (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum (BTL pa B2'') B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum (BENQ pa (BHD pa B2'') B3'') B3)))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "B2'' pa \<noteq> []"
        and "pa \<notin> defaults"
      for pa :: 'a
    ...
    moreover have "\<exists>op2'. (step Tau)\<^sup>*\<^sup>* (map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3)))) op2' \<and> wbisim_cong (\<lambda>op1 op2. \<exists>A A1 A1' A1'' B'' B1 B1' B1'' A2 A2' B2 B2'' A3 A3'. op1 = map_op projl projr (comp_op Some (case_sum A2' A2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (aeq_op (case_sum A1'' A1')) (id_op A1)) (aeq_op (case_sum A3' A3))) \<and> (\<exists>B3 B3''. op2 = map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' B2) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' B3)))) \<and> A = (A1 >> A2) >> A3 \<and> B'' = (B1'' >> B2'') >> B3'' \<and> (\<forall>p. \<exists>m n. A1'' p = drop n (B'' p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (A p) \<and> (A2' >> A3') p = tested n (C p) (B'' p) \<and> (B2 >> B3) p = tested m (A p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (B'' p) \<and> m \<le> length (C p) \<and> m \<le> length (A p))))) op2' (map_op assoc id (map_op projl projr (comp_op Some (case_sum B2'' (BTL pa B2)) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op B1'') (aeq_op (case_sum B1' B1))) (aeq_op (case_sum B3'' (BENQ pa (BHD pa B2) B3))))))"
      if "\<forall>p. \<exists>m n. A1'' p = drop n (((B1'' >> B2'') >> B3'') p) \<and> (\<exists>C. A1' p = drop n (C p) \<and> B1' p = drop m (C p) \<and> B1 p = drop m (((A1 >> A2) >> A3) p) \<and> (A2' >> A3') p = tested n (C p) (((B1'' >> B2'') >> B3'') p) \<and> (B2 >> B3) p = tested m (((A1 >> A2) >> A3) p) (C p) \<and> n \<le> length (C p) \<and> n \<le> length (((B1'' >> B2'') >> B3'') p) \<and> m \<le> length (C p) \<and> m \<le> length (((A1 >> A2) >> A3) p))"
        and "B2 pa \<noteq> []"
        and "pa \<notin> defaults"
      for pa :: 'a
    ...
    ultimately show ?thesis
      subgoal premises prems
        using SIM2 by (auto elim !: step_map_op_elim step_comp_op_elim step_aeq_op_elim step_id_op_cases simp add: prems)
      done
  qed
qed
