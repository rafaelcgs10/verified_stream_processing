...
value [GHC] "unit_test (check_prefix [((1, 1), (Inr 10, MyPair 1 1)), ((1, 1), (Inr 7, MyPair 0 1)),((1, 1), (Inr 3, MyPair 1 0))] (compile_dataflow_opt (\<lambda> _. []) (batch_tree (\<lambda> _. inps_test) batch_max))) True"
...
value [GHC] "unit_test (check_prefix [((1, 1), (Inr 7, MyPair 0 0))] (compile_dataflow_opt (\<lambda> _. []) (batch_tree (\<lambda> _. inps_test2) batch_max))) True"
value [GHC] "unit_test (check_prefix [((1, 1), (Inr 10, MyPair 1 0))] (compile_dataflow_opt (\<lambda> _. []) (batch_tree (\<lambda> _. inps_test2) batch_max))) True"

value [GHC] "unit_test (check_prefix [((1, 1), (Inr 7, MyPair 0 0)), ((1, 1), (Inr 10, MyPair 1 0))] (compile_dataflow_opt (\<lambda> _. []) (batch_tree (\<lambda> _. inps_test2) batch_max))) True"
value [GHC] "unit_test (check_prefix [((1, 1), (Inr 10, MyPair 1 0)), ((1, 1), (Inr 7, MyPair 0 0))] (compile_dataflow_opt (\<lambda> _. []) (batch_tree (\<lambda> _. inps_test2) batch_max))) True"

value [GHC] "unit_test (check_prefix [((1, 1), (Inr 7, MyPair 0 1)), ((1, 1), (Inr 10, MyPair 1 1)), ((1, 1), (Inr 3, MyPair 1 0))] (compile_dataflow_opt (\<lambda> _. []) (batch_tree (\<lambda> _. inps_test) batch_max))) True"
...
value [GHC] "unit_test (check_prefix [((1, 1), (Inr 7, MyPair 0 1)), ((1, 1), (Inr 10, MyPair 1 0))] prog) True"
(* WARNING: the check above takes about eleven minutes. The schedule it looks
   for pauses the input operator between its two drops, and the search of
   check_prefix only reaches it after exploring every schedule that keeps
   draining the input first. Every other check in this file answers in under a
   minute. *)

text \<open>Consumption-driven order.\<close>

value [GHC] "unit_test (check_prefix [((1, 1), (Inr 10, MyPair 1 0)), ((1, 1), (Inr 7, MyPair 0 1))] prog) True"
...
value [GHC] "unit_test (check_prefix [((1, 1), (Inr 10, MyPair 0 1))] prog) False"
 *)
