theory Batch_Op_Correctness_Mset
...
lemma correctness_gen:
  ...
  shows 
    \<open>mset_op (cmset_of_cset S) (cmset_of_cset D) (dataflow_op sg (G_op f ip_state bt_state cbufs))
  \<approx> mset_spec_op (cmset_of_cset (cUn (cUn S SO) SP)) (cmset_of_cset D)\<close>
  using assms apply -
  ...
  proof -
    ...
    show ?thesis 
      ...
      subgoal premises prems2
        ...
        apply (elim step_builder_op_elim step_mset_op_elim step_map_op_elim step_comp_op_elim step_dataflow_op_elim conjE ; 
        ...
        subgoal 
          ...
          apply (intro exI conjI relcomppI)
             apply (rule step_mset_spec_op_intro_Out)
               apply (rule refl)
          unfolding cmset_cmset_of_cset_minus apply fastforce
             apply (rule refl)
          ...
          unfolding wsim_def dataflow_tree_to_operator_def batch_op_def batch_op_logic_def ooo_input_op_def ooo_input_op_logic_def notifier_op_def
                      apply simp
          apply (simp add: SIM1 cminsert_cmset_of_cset)
                     apply (simp add: SIM1 cminsert_cmset_of_cset)
                     apply (simp add: SIM1)
