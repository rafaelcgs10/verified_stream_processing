...
notepad begin
  ...
  define sg_3 where \<open>sg_3 = sg_2\<lparr>upfro := (\<lambda> _. True), pt_tr := change_multiplicities (summ sg_2) (extract_progress 0 (nxt sg_2) st0) (pt_tr sg_2)\<rparr>\<close>
