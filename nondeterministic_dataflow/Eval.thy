...
value [GHC] "force_cset undefined 10 (cimage fst (eval 10 W42))"
value [GHC] "force_cset undefined 10 (cimage fst (eval 10 CP))"
value [GHC] "force_cset undefined 100 (cimage fst (eval 10 cp_op))"
value [GHC] "force_cset undefined 100 (cimage fst (eval 1000 (CP \<bullet> CP)))"
value [GHC] "force_cset undefined 100 (cimage fst (eval 10 (cp_op \<bullet> cp_op)))"
value [GHC] "force_cset undefined 100 (cimage fst (eval 10 (cp_op \<parallel> cp_op)))"
