...
proof (coinduction arbitrary: buf1 buf1' buf2 buf2' buf3 buf3' buf3'' rule: bisim_coinduct_upto)
  ...
  proof (intro allI conjI impI)
    fix io :: "('a, ('a + 'a) + 'a, 'b) IO"
      and op1' :: "('a, ('a + 'a) + 'a, 'b) op"
    assume H: "step io (map_op projl projr (comp_op Some (case_sum buf2 buf2') (split_op (case_sum buf1 buf1')) (comp_op (\<lambda>_. None) (\<lambda>_. []) (split_op (case_sum buf3 buf3')) (id_op buf3'')))) op1'"
    show "\<exists>op2'. step io (map_op id (case_sum Inr Inl) (map_op projl projr (comp_op Some (case_sum buf2' buf2) (split_op (case_sum buf1' buf1)) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op buf3'') (split_op (case_sum buf3 buf3')))))) op2' \<and> bisim_cong (\<lambda>s t. \<exists>buf1 buf1' buf2 buf2' buf3 buf3' buf3''. s = map_op projl projr (comp_op Some (case_sum buf2 buf2') (split_op (case_sum buf1 buf1')) (comp_op (\<lambda>_. None) (\<lambda>_. []) (split_op (case_sum buf3 buf3')) (id_op buf3''))) \<and> t = map_op id (case_sum Inr Inl) (map_op projl projr (comp_op Some (case_sum buf2' buf2) (split_op (case_sum buf1' buf1)) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op buf3'') (split_op (case_sum buf3 buf3')))))) op1' op2'"
      using H by (auto elim!: step_map_op_elim step_comp_op_elim step_split_op_cases step_id_op_cases split: sum.splits) (fastforce intro: bc_base)+
  next
    fix io :: "('a, ('a + 'a) + 'a, 'b) IO"
      and op1' :: "('a, ('a + 'a) + 'a, 'b) op"
    assume H: "step io (map_op id (case_sum Inr Inl) (map_op projl projr (comp_op Some (case_sum buf2' buf2) (split_op (case_sum buf1' buf1)) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op buf3'') (split_op (case_sum buf3 buf3')))))) op1'"
    show "\<exists>op2'. step io (map_op projl projr (comp_op Some (case_sum buf2 buf2') (split_op (case_sum buf1 buf1')) (comp_op (\<lambda>_. None) (\<lambda>_. []) (split_op (case_sum buf3 buf3')) (id_op buf3'')))) op2' \<and> bisim_cong (\<lambda>s t. \<exists>buf1 buf1' buf2 buf2' buf3 buf3' buf3''. s = map_op projl projr (comp_op Some (case_sum buf2 buf2') (split_op (case_sum buf1 buf1')) (comp_op (\<lambda>_. None) (\<lambda>_. []) (split_op (case_sum buf3 buf3')) (id_op buf3''))) \<and> t = map_op id (case_sum Inr Inl) (map_op projl projr (comp_op Some (case_sum buf2' buf2) (split_op (case_sum buf1' buf1)) (comp_op (\<lambda>_. None) (\<lambda>_. []) (id_op buf3'') (split_op (case_sum buf3 buf3')))))) op1' op2'"
      using H by (auto elim!: step_map_op_elim step_comp_op_elim step_split_op_cases step_id_op_cases split: sum.splits) (fastforce intro: bc_sym[OF bc_base])+
  qed
qed

lemma A5:
  \<open>\<Lambda> \<bullet> (\<Lambda> \<parallel> \<I>) ~ map_op id (case_sum Inr Inl) (\<Lambda> \<bullet> (\<I> \<parallel> \<Lambda>))\<close>
  unfolding scomp_op_def
